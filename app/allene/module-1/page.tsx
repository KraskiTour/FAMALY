...
export const metadata: Metadata = {
  title: 'Allene — Модуль 1',
  description: 'Тестовая страница модуля Allene №1.',
  alternates: { canonical: '/allene/module-1' },
};

export default function AlleneModuleOnePage() {
  return (
    <div className="bg-gray-50/50 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span className="text-gray-300">/</span>
          <span className="text-gray-600 font-medium">Модуль 1</span>
        </nav>

        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight mb-6">Модуль 1</h1>
        <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-card min-h-[520px]">
          ...
          <div className="s-partnership" style={{ display: 'none' }}>
            Lsodo1dIpEzP%2B%2Bs1rHL%2BH3A5O911HHBwk%2BnHuHJdDtU%3D
          </div>
        </div>
      </div>
    </div>
