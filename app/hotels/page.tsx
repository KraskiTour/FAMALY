...
export const metadata: Metadata = {
  ...
  description: 'Подберите и забронируйте отель через партнерский виджет на странице KRASKI.TRAVEL.',
    ...
    <div className="bg-gray-50/50 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span className="text-gray-600 font-medium">Подбор отелей</span>
        </nav>
        ...
        <header className="mb-6 lg:mb-8">
          ...
          <p className="mt-3 text-base sm:text-lg text-gray-500 max-w-3xl leading-relaxed">
            Выберите город, даты и подходящий вариант размещения. Цены и доступность обновляются в реальном времени.
          </p>
        </header>
