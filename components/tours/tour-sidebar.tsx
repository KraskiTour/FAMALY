...
export default function TourSidebar({ tour }: TourSidebarProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-elevated border border-gray-100 p-6 lg:sticky lg:top-24">
      <div className="mb-5 pb-5 border-b border-gray-100">
        ...
        <div className="text-3xl font-extrabold text-gray-900 tracking-tight">{formatPrice(tour.priceFrom)}</div>
            ...
            {tour.nextDates.map((date, idx) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  {date.seatsLeft != null && date.seatsLeft <= 10 && (
        ...
        {!showForm ? (
          <>
            ...
            <div className="flex gap-2">
              <a href={CONTACTS.telegram.url} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('click_telegram', { tour: tour.slug })} className="flex-1 inline-flex items-center justify-center gap-1.5 bg-blue-500 text-white py-2.5 rounded-2xl text-sm font-semibold hover:bg-blue-600 transition-colors">
                Telegram
              </a>
              <a href={CONTACTS.max.url} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('click_max', { tour: tour.slug })} className="flex-1 inline-flex items-center justify-center gap-1.5 bg-violet-600 text-white py-2.5 rounded-2xl text-sm font-semibold hover:bg-violet-700 transition-colors">
                MAX
              </a>
            </div>
          </>
