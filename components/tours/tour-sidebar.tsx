...
export default function TourSidebar({ tour }: TourSidebarProps) {
  ...
  const handleSubmit = () => {
    ...
    window.open(maxMiniAppUrl, '_blank');
    setSent(true);
  };
        ...
        {!showForm ? (
          <>
            ...
            <a
              ...
              onClick={() => trackEvent('click_max', { tour: tour.slug })}
              className="w-full inline-flex items-center justify-center gap-2 bg-violet-600 text-white py-3 rounded-2xl text-sm font-bold hover:bg-violet-700 transition-colors"
            >
              MAX
            </a>
          ...
          <div className="text-center py-4">
            ...
            <p className="text-xs text-gray-500 mt-1">Ответим в MAX в течение 15 минут</p>
