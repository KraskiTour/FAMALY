const advantages = [
  {
    ...
    title: 'Путешествия для любого формата',
  ...
  },
  {
    ...
    title: 'Удобная бронь в одном окне',
  ...
  },
  {
    ...
    title: 'Яркие поездки круглый год',
...
export default function Advantages() {
  return (
    <section className="section-y bg-gradient-to-b from-white to-stone-50/70">
      <div className="container-page">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
          {advantages.map((item) => (
            <div
              key={item.title}
              className="group bg-white rounded-2xl border border-gray-200/70 p-6 lg:p-7 hover:border-brand-200 hover:shadow-card-hover transition-all duration-300"
            >
